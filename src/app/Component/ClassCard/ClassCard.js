...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 340" width={36} height={36}>
    <g data-name="Layer 7">
      <path d="M318.586 28.226a6.369 6.369 0 0 0-6.367 6.26l-2.292 135.2h17.319l-2.293-135.2a6.369 6.369 0 0 0-6.367-6.26z" style={{ fill: "#dde5f4" }} />
...
/>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 md:gap-4">
          <a href={classData.meetingLink} target="_blank" rel="noopener noreferrer">
            <div type="button" className="inline-flex items-center justify-center text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 font-semibold rounded-xl text-base md:text-lg px-6 md:px-8 py-3 md:py-3.5 text-center shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200 w-full md:w-auto cursor-pointer">Join Class</div>
          </a>
